...
drawPlayingField:
	...
	mov	sl, r0	@  playingField
	mov	r8, #0	@  row
.L27:
	mov	r5, #0	@  col
	mov	r6, r8, asl #3	@  y,  row
	add	r4, sl, r8, asl #2	@  playingField,  row
.L26:
	ldr	r3, [r4, #0]	@  block_type
	mov	r3, r3, asl #1	@  block_type
	mov	r0, r5, asl #3	@  x,  col
	ldrh	r2, [r3, r7]	@  blkColors
	mov	r1, r6	@  y
	add	r5, r5, #1	@  col,  col
	bl	drawBlk
	cmp	r5, #19	@  col
...
initNewPiece:
	...
	ldr	r2, .L179+16
	ldr	r3, .L179+20
	str	ip, [r2, #0]	@  currentBlk
	str	r0, [r3, #0]	@  orientationIndex
	ldmea	fp, {fp, sp, lr}
	b	drawCurrentPiece
.L180:
	.align	2
...
canMove:
	...
	ldr	r3, .L199
	ldr	ip, [r3, #0]	@  tetriminoIndex
	ldr	r7, .L199+4
	add	r2, r2, ip, asl #2	@  newRotation
	ldr	sl, .L199+8
	mov	r6, r0	@  newX
	mov	r5, r1	@  newY
	mov	r8, r2, asl #4
...
.L194:
	...
	add	lr, r8, r4	@  i
.L193:
	ldr	r3, [r7, lr, asl #2]	@  tetriminos
	cmp	r3, #0
	add	ip, r5, r0	@  y,  newY,  j
	add	r1, r6, r4	@  x,  newX,  i
	add	r0, r0, #1	@  j,  j
	add	lr, lr, #4
	beq	.L188
	cmp	ip, #23	@  y
	movle	r3, #0
	movgt	r3, #1
	add	r2, ip, ip, asl #2	@  y,  y
	add	r2, r1, r2, asl #1	@  x
	cmp	r1, #9	@  x
	movls	r1, r3	@  newX
	orrhi	r1, r3, #1	@  newX
	cmp	r1, #0	@  newX
	...
	cmp	ip, #0	@  y
	blt	.L188
	ldr	r3, [sl, r2, asl #2]	@  board
	cmp	r3, #0
	movne	r0, r1	@  newX,  newX
	bne	.L181
.L188:
	cmp	r0, #3	@  j
	ble	.L193
...
deleteFullRows:
	...
	mov	r8, #0	@  fullRows
	sub	sp, sp, #960
	mov	r0, r8	@  i,  fullRows
	mov	r2, r8	@  fullRows,  fullRows
.L244:
	add	r3, r0, r0, asl #2	@  i,  i
	add	r1, sp, #960
	add	r3, r1, r3, asl #3
	mov	lr, #9	@  j
.L243:
...
.L254:
	add	r3, r4, r0	@  i
	ldr	r2, [r5, r3, asl #2]	@  isFull,  board
	add	r0, r0, #1	@  i,  i
	cmp	r2, #0	@  isFull
	moveq	r1, #0	@  isFull
	cmp	r0, #9	@  i
...
.L261:
	add	r3, ip, r0	@  i
	ldr	r2, [r5, r3, asl #2]	@  board
	add	r0, r0, #1	@  i,  i
	cmp	r0, #9	@  i
	str	r2, [r1, #-960]	@  newBoard
	add	r1, r1, #4
	ble	.L261
	sub	r6, r6, #1	@  k,  k
.L247:
...
.L271:
	add	r2, ip, r0	@  j,  i
	ldr	r3, [r1, #-960]	@  newBoard
	add	r0, r0, #1	@  i,  i
	cmp	r0, #9	@  i
	str	r3, [r5, r2, asl #2]	@  board
	add	r1, r1, #4
	ble	.L271
	add	lr, lr, #1	@  j,  j
	cmp	lr, #23	@  j
